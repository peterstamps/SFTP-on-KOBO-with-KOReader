...
8. Copy and Add the following text in a file called: /media/user/KOBOeReader/.adds/koreader/scripts/mydropbear.sh  (where 'user' in path is your user login name on Linux)
